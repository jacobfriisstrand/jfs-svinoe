  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-background bg-sidebar text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
